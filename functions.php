...
define( 'STANDARD_THEME_VERSION', '3.3.5' );
...
function standard_theme_menu() {
    ...
    add_menu_page(
        ...
        get_template_directory_uri() . '/assets/images/icn-standard-small.png',
        59
    );
...
function standard_setup_theme_presentation_options() {
    ...
    add_settings_field(
        ...
        'layout',
        array(
            'option_image_path' => get_template_directory_uri() . '/assets/images/layout-left.gif'
        )
    );
    ...
    add_settings_field(
        ...
        'layout',
        array(
            'option_image_path' => get_template_directory_uri() . '/assets/images/layout-right.gif'
        )
    );
    ...
    add_settings_field(
        ...
        'layout',
        array(
            'option_image_path' => get_template_directory_uri() . '/assets/images/layout-full.gif'
        )
    );
...
function standard_find_new_social_icons() {
    ...
    if( $handle = opendir( get_template_directory() . '/assets/images/social/small' ) ) {
        ...
        while( false != ( $filename = readdir( $handle ) ) ) {
            ...
            if( '.' != $filename && '..' != $filename && '.ds_store' != strtolower( $filename) ) {
                ...
                $new_icon_filename = '/assets/images/social/small/' . $filename . ';';
...
function standard_add_theme_stylesheets() {
    ...
    // bootstrap
    wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.css', false, STANDARD_THEME_VERSION );
    ...
    if( 'dark' == $options['contrast'] ) {
        wp_enqueue_style( 'standard-contrast', get_template_directory_uri() . '/assets/css/theme.contrast-light.css', array( 'standard' ), STANDARD_THEME_VERSION );
    } // end if
...
function standard_add_theme_scripts() {
    ...
    // bootstrap
    wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array( 'jquery' ), STANDARD_THEME_VERSION );

    // fitvid
    wp_enqueue_script( 'fitvid', get_template_directory_uri() . '/assets/js/lib/jquery.fitvids.js', false, STANDARD_THEME_VERSION );

    // comment-reply
    if ( is_singular() && get_option( 'thread_comments' ) ) {

        wp_enqueue_script( 'comment-reply' );
        wp_enqueue_script( 'md5', get_template_directory_uri() . '/assets/js/lib/md5.js', false, STANDARD_THEME_VERSION );

    } // end if

    wp_enqueue_script( 'theme-main', get_template_directory_uri() . '/assets/js/theme.main.min.js', false, STANDARD_THEME_VERSION );
...
function standard_add_admin_stylesheets() {
    wp_enqueue_style( 'standard-admin', get_template_directory_uri() . '/assets/css/admin.css', false, STANDARD_THEME_VERSION );
...
function standard_add_admin_script() {
    ...
    wp_enqueue_script( 'standard-admin', get_template_directory_uri() . '/assets/js/admin.min.js?using_sitemap=' . get_option( 'standard_using_sitemap' ), $dependencies, STANDARD_THEME_VERSION );

    $screen = get_current_screen();
    if( 'post' != $screen->base && 'page' != $screen->base ) {
        wp_enqueue_script( 'standard-admin-media', get_template_directory_uri() . '/assets/js/admin.media-upload.min.js', $dependencies, STANDARD_THEME_VERSION );
    } // end if
